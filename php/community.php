<?php
  ...
  $to                 = "masuwasani@yahoo.com";
	$subject            = "Aanmelden community";
  $body               = "Bericht via het community aanmeldingsformulier van Genieten van Meditatie:";
  ...
  <body>
      ...
      <div class="container2 container">
        ...
        <div class="collapse navbar-collapse" id="mobilenav">
          <ul class="navbar-nav ml-auto my-2 my-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../wat_ik_aanbied.html">Wat ik aanbied</a>
            </li>
            <li class="nav-item">
    ...
    <div class="sectionbox">
      <section>
        ...
        <p>
          Ik zal spoedig contact met je opnemen over je deelname aan de community!
        </p>
      </section>
    </div>
